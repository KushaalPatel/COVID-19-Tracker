...
Utilizing the following api `https://covid19.mathdro.id/api` in order to pull current up to date data.
Displaying the data numerically and graphical based on the selected country.
